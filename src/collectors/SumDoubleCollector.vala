...
private class Gpseq.Collectors.SumDoubleCollector<G> : Object, Collector<G,Accumulator,double?> {
	private MapFunc<double?,G> _mapper;

	public SumDoubleCollector (owned MapFunc<double?,G> mapper) {
