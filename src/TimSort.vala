/* TimSort.vala
 *
 * This file has been forked from timsort.vala of libgee 0.20.0.
 * see the below libgee license information.
 *
 * changes:
 *  * Change namespace Gee.TimSort -> Gpseq.TimSort
 *  * Add sort_sub_array()
 *  * Remove sort()
 *  * Remove sort_list()
 *  * Remove sort_arraylist()
 *  * Remove field 'list_collection'
 *  * Remove field 'array'
 */
...
internal class Gpseq.TimSort<G> : Object {
	...
	public static void sort_sub_array<G> (SubArray<G> array, CompareDataFunc<G> compare) {
		...
		helper.list = array.data;
		helper.index = 0;
		helper.size = array.size;
